...
# -----------------------------
# Sauvegarde JSON unifié
# -----------------------------
output_path = Path("results/iocs_unified_bert.json")
output_path.parent.mkdir(exist_ok=True)
with open(output_path, "w", encoding="utf-8") as f:
    json.dump(unified_iocs, f, indent=4)

print("Unified IoCs with BERT NER saved to results/iocs_unified_bert.json")
