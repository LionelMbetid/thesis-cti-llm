...
# -----------------------------
# Charger le JSON unifié final
# -----------------------------
unified_path = Path("results/iocs_final_unified.json")
...
output_path = Path("results/iocs_comparison_final.json")
with open(output_path, "w", encoding="utf-8") as f:
    json.dump(comparison_output, f, indent=4)

print("\nIoCs comparison saved to results/iocs_comparison_final.json")
